...
<div class="row">
    <div class="col-75">
        <div class="container">
            <form action="/AdaugareCont" method="post">
                ...
                <div class="row">
                    <div class="col-50">
                        ...
                        <input type="text" id="fname" name="amount" placeholder="Introduceti suma noului card...">
                        <label for="email"><i class="fa fa-envelope"></i>Valuta noului Card</label>
                        <input type="text" id="email" name="valuta" placeholder="Introduceti valuta noului card...">
                        <label for="adr"><i class="fa fa-address-card-o"></i> Numarul noului Card</label>
                        <input type="text" id="adr" name="nrCard" placeholder="Introduceti Nr. Card...">


                    </div>

                </div>
                <input type="submit" name="btn_submit" value="Adauga Card" class="btn">
            </form>
        </div>
    </div>
